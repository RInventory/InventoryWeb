...
<div class="col-md-12 graphs">
  <div class="xs">
    ...
    <div class="bs-example4" data-example-id="simple-responsive-table">
      ...
      <center><p style="color: #fff; background-color: #0B2161"><?php echo anchor('auth/create_user', lang('index_create_user_link'))?> | <?php echo anchor('auth/create_group', lang('index_create_group_link'))?></p></center>
        ...
        <table class="table">
          ...
          <tbody> 
            ...
            foreach ($users as $user){ ?>
				<tr>
		            <td style="color: #000"><?php echo htmlspecialchars($user->first_name,ENT_QUOTES,'UTF-8');?></td>
		            <td style="color: #000"><?php echo htmlspecialchars($user->last_name,ENT_QUOTES,'UTF-8');?></td>
		            <td style="color: #000"><?php echo htmlspecialchars($user->email,ENT_QUOTES,'UTF-8');?></td>
					<td style="color: #000">
						<?php foreach ($user->groups as $group):?>
							<?php echo anchor("auth/edit_group/".$group->id, htmlspecialchars($group->name,ENT_QUOTES,'UTF-8')) ;?><br />
		                <?php endforeach?>
					</td>
					<td style="color: #000"><?php echo ($user->active) ? anchor("auth/deactivate/".$user->id, lang('index_active_link')) : anchor("auth/activate/". $user->id, lang('index_inactive_link'));?></td>
					<td style="color: #000"><?php echo anchor("auth/edit_user/".$user->id, 'Edit') ;?></td>
				</tr>
            <?php $no++;} ?>
          </tbody>
        </table>
