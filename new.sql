...
-- -----------------------------------------------------
-- Placeholder table for view `inven`.`nama_kategori`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inven`.`nama_kategori` (`id_barang` INT, `nama_barang` INT, `harga_barang` INT, `stok_barang` INT, `tmp_simpanbarang` INT, `gambar_barang` INT, `kategori_id_kategori` INT, `supplier_id_supplier` INT, `id_kategori` INT, `nama_kategori` INT);

-- -----------------------------------------------------
-- View `inven`.`nama_kategori`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `inven`.`nama_kategori` ;
DROP TABLE IF EXISTS `inven`.`nama_kategori`;
USE `inven`;
CREATE  OR REPLACE VIEW `nama_kategori` AS SELECT * FROM barang , kategori 
